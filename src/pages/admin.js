        ...
        <div className="container">
          <div className="story-content">
            ...
            <div className="story-text">
              <p>
                Fifteen years ago, I had a vision: to create a real estate company that truly puts 
                clients first. Having experienced the frustration of working with agents who seemed 
                more interested in quick sales than understanding my needs, I knew there had to be 
                a better way.
              </p>
              
              <p>
                I started RealEstate Pro in my small apartment with nothing but a laptop, a phone, 
                and an unwavering commitment to honesty and transparency. Those early days were 
                challenging, but every satisfied client reinforced my belief that genuine care and 
              ...
              <p>
                Today, as I look back on our journey, I'm filled with gratitude—for our amazing 
                clients who trusted us with their biggest life decisions, for our dedicated team 
                who brings passion to work every day, and for the opportunity to make a positive 
        ...
        <div className="container">
          ...
          <div className="values-grid">
            ...
            <div className="value-item">
              ...
              <h3>Excellence</h3>
              <p>Good enough isn't good enough. We strive for excellence in every interaction, every transaction, every relationship.</p>
            </div>
            <div className="value-item">
            ...
            <div className="value-item">
              ...
              <h3>Growth</h3>
              <p>Continuous learning and adaptation ensure we always provide our clients with the best service and latest market insights.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="personal-message">
        <div className="container">
          <div className="message-card">
            ...
            <p>
              "To every client who chooses RealEstate Pro, I make this promise: You're not just 
              a transaction to us. You're part of our extended family. We'll work tirelessly to 
              understand your needs, respect your timeline, and deliver results that exceed your 
              expectations. Your success is our success, and your satisfaction is our greatest reward."
            </p>
